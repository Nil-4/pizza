...
<body class="u-body u-xl-mode" data-lang="en">
  ...
  <section class="u-align-center u-clearfix u-grey-5 u-section-1" id="sec-fe51">
    <div class="u-clearfix u-sheet u-sheet-1">
      <h1 class="u-text u-text-default u-text-1">Bize Ulaşın</h1>
      <div class="u-form u-form-1">
        <form action="iletisim.php" method="POST" class="" style="padding: 10px">
          <div class="u-form-group u-form-name u-label-none">
            <label for="name-3b9a" class="u-label">Name</label>
            <input readonly type="text" placeholder="Adınız" value="<?= $_SESSION["kullanici_ad"] ?>" id="kullanici_ad" name="kullanici_ad" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-1" required="">
          </div>
          <div class="u-form-group u-form-name u-label-none">
            <label for="name-3b9a" class="u-label">Surname</label>
            <input readonly type="text" placeholder="Soyadınız" value="<?= $_SESSION["kullanici_soyad"] ?>" id="kullanici_soyad" name="kullanici_soyad" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-1" required="">
          </div>
          <div class="u-form-email u-form-group u-label-none">
            <label for="email-3b9a" class="u-label">Email</label>
            <input readonly type="email" placeholder="E-posta Adresiniz" value="<?= $_SESSION["kullanici_email"] ?>" id="kullanici_email" name="kullanici_email" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-2" required="">
          </div>
          <div class="u-form-group u-form-message u-label-none">
            <label for="message-3b9a" class="u-label">Message</label>
            <textarea placeholder="Mesajınız" rows="4" cols="50" id="kullanici_mesaj" name="kullanici_mesaj" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-3" required="required"></textarea>
          </div>
          <div class="u-form-group u-form-message u-label-none">
            <input type="submit" value="GÖNDER" style="cursor:pointer; width:100%;" />
          </div>
...
$kullanici_mesaj = $_POST["kullanici_mesaj"] ?? null;
if (isset($kullanici_mesaj)) {


  $kullanici_ad = $_SESSION["kullanici_ad"];
  $kullanici_soyad = $_SESSION["kullanici_soyad"];
  $kullanici_email = $_SESSION["kullanici_email"];


  $sql2 = "INSERT INTO iletisim (ad,soyad,eposta,mesaj) VALUES ('" . $kullanici_ad . "', '" . $kullanici_soyad . "', '" . $kullanici_email . "','" . $kullanici_mesaj . "')";
  $sorgu2 = mysqli_query($veritabani, $sql2);
  if ($sorgu2) {
    echo "<script>alert('Mesajınız başarıyla alındı!');</script>";
  } else {
