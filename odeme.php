...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords" content="Ödeme">
  <meta name="description" content="ödeme">
  <title>Ödeme</title>
  <link rel="shortcut icon" href="images/default-logo.png">
  <link rel="stylesheet" href="css/odeme_2.css" media="screen">
  <link rel="stylesheet" href="css/odeme.css" media="screen">
  <script class="u-script" type="text/javascript" src="js/odeme_jquery.js" defer=""></script>
  <script class="u-script" type="text/javascript" src="js/odeme.js" defer=""></script>
  ...
  <meta property="og:title" content="odeme">
...
<body class="u-body u-xl-mode" data-lang="en">
            ...
            <li class="u-nav-item"><a class="u-border-2 u-border-active-grey-90 u-border-hover-grey-50 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-grey-40 u-text-hover-grey-40" href="tum_pizza.php" style="padding: 10px 0px;">PİZZALAR</a>
              <div class="u-nav-popup">
                <ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10">
                  <li class="u-nav-item"><a href="tum_pizza.php" class="u-button-style u-nav-link u-white">Tüm Pizzalar</a>
                  </li>
          ...
          <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
            <div class="u-inner-container-layout u-sidenav-overflow">
              ...
              <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-3">
                ...
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="icecek.html">İçecekler</a>
                </li>
  ...
  <section class="u-align-center u-clearfix u-section-1" id="sec-1128">
    <div class="u-clearfix u-sheet u-sheet-1">
      <h2 class="u-text u-text-default u-text-1">Ödeme</h2>
      <div class="u-form u-form-1">
        <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px" source="email" name="form">
          <div class="u-form-group u-form-name u-label-none">
            ...
            <input type="text" placeholder="Adınız" id="name-3b9a" name="name" class="u-input u-input-rectangle" required="">
          </div>
          <div class="u-form-group u-label-none u-form-group-2">
            <label for="text-a83e" class="u-label">Giriş</label>
            <input type="text" placeholder="Soyadınız" id="text-a83e" name="surname" class="u-input u-input-rectangle">
          </div>
          <div class="u-form-group u-label-none u-form-group-3">
            <label for="text-3268" class="u-label">Giriş</label>
            <input type="number" min="5000000000000000" max="5999999999999999" placeholder="Kart Numaranız" id="text-3268" name="credit card" class="u-input u-input-rectangle">
          </div>
          <div class="u-form-date u-form-group u-label-none u-form-group-4">
            <label for="ay" class="u-label">Ay</label>
            <select id="ay" name="ay" class="u-input u-input-rectangle">
          ...
          <div class="u-form-date u-form-group u-label-none u-form-group-4">
            <label for="yil" class="u-label">Yıl</label>
            <select id="yil" name="yil" class="u-input u-input-rectangle">
              <option value="2023">23</option>
              <option value="2023">24</option>
              <option value="2023">25</option>
              <option value="2023">26</option>
              <option value="2023">27</option>
              <option value="2023">28</option>
              <option value="2023">29</option>
              <option value="2023">30</option>
            </select>
          </div>
          <div class="u-form-group u-label-none u-form-group-5">
            <label for="text-5bef" class="u-label">Giriş</label>
            <input type="number" min="100" max="999" placeholder="CVV" id="text-5bef" name="cvv" class="u-input u-input-rectangle">
          </div>
          <div class="u-align-left u-form-group u-form-submit">
            <a href="#" class="u-btn u-btn-submit u-button-style u-custom-color-5 u-btn-1">Onayla</a>
            <input type="submit" value="submit" class="u-form-control-hidden">
          </div>
          <div class="u-form-send-message u-form-send-success"> Ödeme Başarılı </div>
          <div class="u-form-send-error u-form-send-message"> Ödeme Başarısız </div>
          <input type="hidden" value="" name="recaptchaResponse">
          <input type="hidden" name="formServices" value="ce6d1b1f0bb674b344f8f8ae74fb1e71">
        </form>
      </div>
    </div>
  </section>
