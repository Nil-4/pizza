...
<head>
  ...
  <body data-home-page="index.php" data-home-page-title="Home" class="u-body u-xl-mode" data-lang="en">
          ...
          <div class="u-layout-row">
            ...
            <div class="u-black u-container-style u-layout-cell u-size-20-xl u-size-22-lg u-size-22-sm u-size-22-xs u-size-60-md u-layout-cell-2">
              <div class="u-container-layout u-valign-middle-md u-container-layout-2">
                <h1 class="u-align-center u-color-scheme-u11 u-color-style-multicolor-1 u-custom-font u-text u-text-palette-2-base u-text-1">lo30</h1>
                ...
                <div class="u-align-center u-expanded-width-sm u-expanded-width-xs u-form u-login-control u-white u-form-1">
                  <form action="#" class="u-clearfix u-form-custom-backend u-form-spacing-20 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 30px;" method="post">
                    <div class="u-form-group u-form-name">
                      <label for="username-a30d" class="u-label">E-posta Adresi</label>
                      <input type="text" placeholder="Lütfen E-posta Adresinizi Giriniz" id="username-a30d" name="username" class="u-grey-5 u-input u-input-rectangle u-input-1" required="">
                    </div>
                    <div class="u-form-group u-form-password">
                      <label for="password-a30d" class="u-label">Şifre</label>
                      <input type="password" placeholder="Lütfen Şifrenizi Giriniz" id="password-a30d" name="password" class="u-grey-5 u-input u-input-rectangle u-input-2" required="">
                    </div>
                    <div class="u-form-checkbox u-form-group">
                      <input type="checkbox" id="checkbox-a30d" name="remember" value="On" class="u-field-input">
                      <label for="checkbox-a30d" class="u-field-label" style="">Beni Hatırla</label>
                    </div>
                    <div class="u-align-right u-form-group u-form-submit">
                      <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-palette-2-light-1 u-btn-1">Giriş</a>
                      <input type="submit" value="submit" class="u-form-control-hidden">
                    </div>
                    <input type="hidden" value="" name="recaptchaResponse">
                  </form>
                </div>
                <a href="index.php" class="u-align-center u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-body-alt-color u-text-hover-grey-50 u-btn-2">Şifremi Unuttum</a>
                <a href="index.php" class="u-align-center u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-create-account u-none u-text-body-alt-color u-text-hover-grey-50 u-btn-3">Hesabın Yok Mu?</a>
              </div>
            </div>
    ...
    <footer class="u-align-center-md u-align-center-sm u-align-center-xs u-clearfix u-footer u-grey-80" id="sec-5d05"><div class="u-clearfix u-sheet u-sheet-1">
